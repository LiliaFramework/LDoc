...
local function setup_kinds ()
   ...
   ProjectMap:add_kind(lookup('topic','Information'))
   ProjectMap:add_kind(lookup('structures','Structures'))
   ProjectMap:add_kind(lookup('store','Store'))
   ProjectMap:add_kind(lookup('module','Core - Libraries'))
